...
public:
    ...
    void setupUi(QWidget *EditItem)
    {
        if (EditItem->objectName().isEmpty())
            EditItem->setObjectName(QString::fromUtf8("EditItem"));
        EditItem->resize(537, 419);
        EditItem->setStyleSheet(QString::fromUtf8("QPushButton {\n"
...
"}"));
        ...
        listWidget = new QListWidget(EditItem);
        listWidget->setObjectName(QString::fromUtf8("listWidget"));

        horizontalLayout_2->addWidget(listWidget);

        label_2 = new QLabel(EditItem);
        ...
        lineEdit = new QLineEdit(EditItem);
        lineEdit->setObjectName(QString::fromUtf8("lineEdit"));

        horizontalLayout_3->addWidget(lineEdit);

        label_3 = new QLabel(EditItem);
        ...
        pushButton = new QPushButton(EditItem);
    ...
    void retranslateUi(QWidget *EditItem)
    {
        EditItem->setWindowTitle(QCoreApplication::translate("EditItem", "Form", nullptr));
        label->setText(QCoreApplication::translate("EditItem", "TextLabel", nullptr));
        label_2->setText(QCoreApplication::translate("EditItem", "\331\202\330\267\330\271\330\247\330\252 :", nullptr));
        label_3->setText(QCoreApplication::translate("EditItem", "\331\206\330\247\331\205 \330\254\330\257\333\214\330\257 :", nullptr));
        pushButton->setText(QCoreApplication::translate("EditItem", "\330\253\330\250\330\252", nullptr));
    } // retranslateUi
