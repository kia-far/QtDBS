/********************************************************************************
** Form generated from reading UI file 'hidebelonging.ui'
**
...
#ifndef UI_HIDEBELONGING_H
#define UI_HIDEBELONGING_H
...
public:
    ...
    void setupUi(QWidget *HideBelonging)
    {
        if (HideBelonging->objectName().isEmpty())
            HideBelonging->setObjectName(QString::fromUtf8("HideBelonging"));
        HideBelonging->resize(400, 300);
        HideBelonging->setStyleSheet(QString::fromUtf8("QPushButton {\n"
...
"    background-color: #e0e6eb; /* Slightly lighter background on focus */\n"
"}"));
        verticalLayout = new QVBoxLayout(HideBelonging);
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        listWidget = new QListWidget(HideBelonging);
        ...
        pushButton = new QPushButton(HideBelonging);
        ...
        retranslateUi(HideBelonging);

        QMetaObject::connectSlotsByName(HideBelonging);
    } // setupUi

    void retranslateUi(QWidget *HideBelonging)
    {
        HideBelonging->setWindowTitle(QCoreApplication::translate("HideBelonging", "Form", nullptr));
        pushButton->setText(QCoreApplication::translate("HideBelonging", "\330\253\330\250\330\252", nullptr));
    } // retranslateUi

};

namespace Ui {
    class HideBelonging: public Ui_HideBelonging {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_HIDEBELONGING_H
