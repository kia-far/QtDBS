...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DatabaseConnection_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_DatabaseConnection_t qt_meta_stringdata_DatabaseConnection = {
    {
QT_MOC_LITERAL(0, 0, 18) // "DatabaseConnection"
...
QT_INIT_METAOBJECT const QMetaObject DatabaseConnection::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_DatabaseConnection.data,
    qt_meta_data_DatabaseConnection,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *DatabaseConnection::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DatabaseConnection.stringdata0))
