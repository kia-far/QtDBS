...
QT_MOC_LITERAL(2, 32, 0) // ""
    ...
    "EditTable\0on_pushButton_clicked\0"
};
...
void EditTable::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<EditTable *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject EditTable::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_EditTable.data,
    qt_meta_data_EditTable,
    qt_static_metacall,
    nullptr,
    nullptr
} };
