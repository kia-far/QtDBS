...
public:
    ...
    void setupUi(QWidget *ProductRegister)
    {
        ...
        gridLayout->addWidget(lineEdit_13, 6, 0, 1, 1);
        ...
        gridLayout->addWidget(lineEdit_12, 5, 0, 1, 1);
        ...
        gridLayout->addWidget(lineEdit_10, 3, 0, 1, 1);

        lineEdit_11 = new QLineEdit(ProductRegister);
        lineEdit_11->setObjectName(QString::fromUtf8("lineEdit_11"));

        gridLayout->addWidget(lineEdit_11, 4, 0, 1, 1);
